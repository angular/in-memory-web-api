  ...
  describe('raw Angular Http', () => {
    ...
    it(
      ...
      async(() => {
        ...
        get$.pipe(map(res => res.json() as Hero[])).subscribe(heroes => {
    ...
    it(
      ...
      async(() => {
        http
          ...
          .pipe(map(res => res.json() as { id: string; name: string }))
          .subscribe(hero => {
    ...
    it(
      ...
      async(() => {
        ...
        http
          ...
          .pipe(concatMap(() => http.get('api/nobodies')), map(res => res.json()))
          .subscribe(nobodies => {
    ...
    it(
      ...
      async(() => {
        http
          ...
          .pipe(concatMap(() => http.get('api/heroes?name=Maxi')), map(res => res.json()))
          .subscribe(heroes => {
