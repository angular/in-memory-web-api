    ...
    BackendService.prototype.commands = function (reqInfo) {
        ...
        switch (command) {
            case 'resetdb':
                ...
                return concatMap.concatMap.call(this.resetDb(reqInfo), function () { return _this.createResponse$(function () { return resOptions; }); });
            case 'config':
                if (method === 'get') {
